  ...
  return (
    <div className='flex p-4 items-center justify-between bg-secondary shadow-sm'>
        ...
        <ul className=' hidden md:flex gap-6'>
          <li className={`hover:text-primary hover:font-bold hover:underline transition-all cursor-pointer ${path=='/dashboard' && 'text-primary font-bold'}`}>Dashboard</li>
          ...
          <li className={`hover:text-primary hover:font-bold hover:underline transition-all cursor-pointer ${path=='/dashboard/how it works' && 'text-primary font-bold'}`}>How it Works?</li>
        </ul>
        <UserButton/>
    </div>
  )
